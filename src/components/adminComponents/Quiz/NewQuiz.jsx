...
export function NewQuiz() {
  ...
  const getInputValue = (e) => {
    if (e.target.name === 'quizImage') {
      ...
      setFormValue({
        ...formValue,
        [e.target.name]: moment(e.target.value).format("YYYY-MM-DDTHH:mm:ss.SSSZ")
      });
    } else {
      setFormValue({
        ...formValue,
  ...
  const formOperation = (e) => {
    ...
    if (id !== 0) {
      axios.put(`http://localhost:5000/api/v1/quizzes/${id}`, formData, {
        withCredentials: true,
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      ...
      axios.post('http://localhost:5000/api/v1/quizzes', formData, {
        withCredentials: true,
        headers: {
          'Content-Type': 'multipart/form-data',
        },
    ...
    return (
          ...
          <form className='mx-2 m-auto rounded-4' onSubmit={formOperation} encType="multipart/form-data">
            ...
            <div className="input-group mb-2">
              ...
              <label htmlFor="exampleInputEmail1" className="form-label fs-5 px-3">No. Attempts</label>
            <div className="input-group mb-2">
            <input type="number"
                     className="form-control rounded-4 p-3" 

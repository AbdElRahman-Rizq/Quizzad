    ...
    <div className='rounded-4'>
      ...
      <Accordion className='' defaultActiveKey="0">
          <Accordion.Item className='my-3 rounded'  eventKey="0">
            <Accordion.Header class="accordion-header text-light">Add Teacher</Accordion.Header>
            <Accordion.Body>
            <div className="teacher mb-3">
              <div className="input-group mb-3 row">
                <input type="search" className="form-control rounded-4 mx-2 p-3 col-md-8" placeholder="insert a teacher name" aria-label="Recipient's username" aria-describedby="button-addon2" />
                <button className="quizButton rounded-4 p-3 col-md-4" type="submit" id="button-addon2">Add teacher</button>
              </div>
            </div>
              <div>
